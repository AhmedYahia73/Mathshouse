...
namespace App\Http\Controllers\Api\Parent\Home;
...
class HomeController extends Controller
{
    ...
    public function view(Request $request, $id){ 
        ...
        $student_data = [];
        $student_data['nick_name'] = $user->nick_name;
        $student_data['grade'] = $user->grade;
        $student_data['category'] = $user->category?->cate_name;
        ...
        $small_package = SmallPackage::where('user_id', $id)
        ->get();
        ...
        ->where('payment_package_order.user_id', $id)
