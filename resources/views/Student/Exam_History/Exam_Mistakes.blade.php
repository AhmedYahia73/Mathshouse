        ...
        @foreach ($mistakes as $item)
            <div class="mistake">
                ...
                @if (!empty($item->question->q_url))
                    <img class="imgMistake" src="{{ asset('images/questions/' . $item->question->q_url) }}"
                        data-bs-toggle="modal" data-bs-target="#kt_modal_edit{{ $item->id }}{{ $item->question->id }}" />
                ...
                <div class="footerMistake">
                    <button type="button" class="my-2 btn viewMistake ans_item_btn btn-primary wallet_btn"
                        data-bs-toggle="modal" data-bs-target="#modalCentermodalCenter{{ $item->question->id }}">
                        View Answer
                    </button>

                    <a href="{{ route('question_parallel', ['id' => $item->question->id]) }}"
                        class="btn btn-info parallelMistake my-2">Solve Parallel</a>

                </div>
                <div class="modal q_ans_item show_wallet d-none" id="modalCenter{{ $item->question->id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('quizze_ques_ans', ['id' => $item->question->id, 'mistake_id' => $item->id]) }}"
