...
@php
    // Defines a function to return the string 'admin' for role-based checks
    function fun_admin()
    {
        return 'admin';
    }
...
<x-default-layout>
    ...
    <!-- Include success message partial -->
    @include('success')

    <!-- Bootstrap CSS and JS dependencies for styling and functionality -->
    ...
    <!-- Custom CSS for styling the page, including custom checkboxes and buttons -->
    <style>
        /* Hide default checkbox for custom styling */
        .btn-container input {
            display: none;
        }
        .btn-container {
        ...
        .add_qz:hover, .edit_qz:hover {
            box-shadow: 0px 0px 5px 5px rgba(134, 134, 134, 0.22);
        }
        .remove_qz, .remove_qz_edit {
            font-size: 1.2rem;
            font-weight: 500;
            padding: 5px 25px;
            border: none;
        ...
        .remove_qz:hover, .remove_qz_edit:hover {
            box-shadow: 0px 0px 5px 5px rgba(134, 134, 134, 0.22);
        }
        .avil {
            font-size: 1.3rem !important;
    ...
    <!-- Button to trigger the modal for creating a new diagnostic exam -->
    <div class="section_add d-flex justify-content-start">
        <button class="btn_add_quizz my-3" type="button" data-toggle="modal" data-target="#exampleModalCenter">New Diagnostic Exam</button>
    </div>

    <!-- Modal for adding a new diagnostic exam -->
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 1300px !important; display: flex; align-items: center; justify-content: center;" role="document">
            <div class="modal-content" style="border-radius: 15px;">
                <form action="{{ route('add_diaexam') }}" method="POST">
                    ...
                    <div class="modal-body" style="padding: 0 1rem !important">
                        <!-- Navigation tabs for Info, Details, and Questions -->
                        <ul class="nav nav-tabs" style="margin-top: 20px;">
                            <li class="nav-item" style="width: calc(100% / 3); text-align: center;">
                                <a class="nav-link active" data-bs-toggle="tab" href="#home">INFO</a>
                            </li>
                        ...
                        <div class="tab-content">
                            <!-- Info Tab: Collects basic exam details -->
                            <div class="tab-pane container active" style="min-height: 300px; max-width: 1340px !important; margin: 15px 0;" id="home">
                                <div style="display: flex; flex-direction: column; align-items: flex-start; row-gap: 15px;">
                                    <div class="col-md-12 d-flex align-items-center justify-content-around">
                                        <span class="col-md-2" style="font-size: 1.2rem;">Title: </span>
                                        <input type="text" name="title" class="col-md-9 form-control" required />
                                    </div>
                                    ...
                                    <div class="col-md-12 d-flex align-items-center justify-content-around">
                                        ...
                                        <div class="col-md-9" style="display: flex; align-items: center; padding: 0; justify-content: start">
                                            <div class="d-flex col-md-2" style="align-items: center; padding: 0; column-gap: 10px">
                                                <span>Hour: </span>
                                                <input type="number" name="time_h_1" max="9" min="0" class="form-control" value="0">
                                                <input type="number" name="time_h_2" max="9" min="0" class="col-md-4 form-control" value="0">
                                            </div>
                                            <div class="d-flex col-md-2" style="align-items: center; padding: 0; column-gap: 10px">
                                                <span>Minutes: </span>
                                                <input type="number" name="time_m_1" max="5" min="0" class="col-md-4 form-control" value="0" />
                                                <input type="number" name="time_m_2" max="9" min="0" class="col-md-4 form-control" value="0" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 d-flex align-items-center justify-content-around">
                                    ...
                                    <div class="col-md-12 d-flex align-items-center justify-content-around">
                                        <span class="col-md-2" style="font-size: 1.2rem;">Pass Score: </span>
                                        <input type="text" name="pass_score" class="col-md-9 form-control" required>
                                    </div>
                                    <div class="col-md-12 d-flex align-items-center justify-content-around">
                                        <span class="col-md-2" style="font-size: 1.2rem;">Active: </span>
                                        <div class="col-md-9 p-0">
                            ...
                            <!-- Details Tab: Selects category and course -->
                            <div class="tab-pane container fade" style="height: 300px; max-width: 1340px !important; margin: 10px 0;" id="menu1">
                                <div style="display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
                                    <div style="display: flex; flex-direction: column; align-items: flex-start; row-gap: 30px;">
                            ...
                            <!-- Questions Tab: Filters and selects questions for the exam -->
                            <div class="tab-pane container fade" style="min-height: 300px; max-width: 1340px !important; margin: 10px 0;" id="menu2">
                                <div style="display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
                                    <div class="d-flex" style="margin-bottom: 1rem; align-items: center; flex-wrap: wrap; justify-content: flex-start; gap: 10px">
                                        <span style="font-size: 1.2rem; font-weight: 600;">Filter Diagnostic:</span>
                                        <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                            <span style="font-size: 1.2rem; font-weight: 600;">Year:</span>
                                            <select id="sel_year" name="year" class="form-control">
                                        ...
                                        <div class="col-md-2 d-flex p-0" style="align-items: center; column-gap:10px">
                                            <span class="col-md-7 pr-0" style="font-size: 1.2rem; font-weight: 600;">Question Num:</span>
                                            <input type="number" id="sel_questionNum" class="col-md-4 form-control" style="padding: .375rem 0 !important; padding-left: 5px !important;" placeholder="Question Num">
                                        </div>
                                        <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                            <span style="font-size: 1.2rem; font-weight: 600;">Chapter:</span>
                                            <select id="sel_chp" name="names" class="form-control">
                                        ...
                                        <div class="col-md-3 d-flex" style="align-items: center; justify-content: space-between; column-gap:20px">
                                            <button type="button" id="filterBtn" style="font-size: 1.4rem; font-weight: 500; border: none; background: #1b84ff; border-radius: 8px; padding: 5px 25px; letter-spacing: 1px; color: #fff;">Filter</button>
                                            <button type="button" class="d-none" id="addAllBtn" style="font-size: 1.4rem; font-weight: 500; border: none; background: #1b84ff; border-radius: 8px; padding: 5px 25px; letter-spacing: 1px; color: #fff;">Add All</button>
                                        </div>
                                    </div>
                                    <input class="category" type="hidden" value="{{ $categories }}" />
                                    <input class="course" type="hidden" value="{{ $courses }}" />
                                    <!-- Table to display available questions -->
                                    ...
                                    <div class="d-flex" style="align-items: center; justify-content: center">
                                        <span style="font-size: 2rem; font-weight: 500; background: #1b84ff; color: #fff; border-radius: 10px; padding: 10px 15px; margin-top: 10px;">Diagnostic Exam</span>
                                    </div>
    ...
    <!-- Table to display all diagnostic exams -->
    <table id="kt_profile_overview_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold dataTable no-footer">
        <thead class="fs-7 text-gray-500 text-uppercase">
            <tr>
                <th style="width: calc(100% / 7);">Serial no.</th>
                <th style="width: calc(100% / 7);">Title</th>
                <th style="width: calc(100% / 7);">Time</th>
                <th style="width: calc(100% / 7);">Score</th>
                <th style="width: calc(100% / 7);">No. of Questions</th>
        ...
        <tbody class="fs-6">
            @foreach ($exams as $item)
                <tr>
                    ...
                    <td>
                        <div style="position: relative; text-align: left;">
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalCenter{{ $item->id }}">Edit</button>
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalDelete{{ $item->id }}">Delete</button>
                            <!-- Modal for editing an existing diagnostic exam -->
                            <div class="modal fade modal_edit" id="modalCenter{{ $item->id }}" style="transform: translate(20px, 0px);" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" style="max-width: 1300px !important; display: flex; align-items: center; justify-content: center;" role="document">
                                    <div class="modal-content" style="border-radius: 15px;">
                                        <form class="form_editquizze" action="{{ route('edit_dia_exam_item', ['id' => $item->id]) }}" method="POST">
                                            @csrf
                                            <div class="modal-header" style="border-bottom: 0 !important;">
                                                <h2 class="modal-title" id="exampleModalLongTitle">Edit Diagnostic</h2>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <div class="modal-body" style="padding: 0 1rem !important">
                                                <!-- Navigation tabs for editing Info and Questions -->
                                                <ul class="nav nav-edit nav-tabs" style="margin-top: 20px;">
                                                ...
                                                <div class="tab-content" id="tab_info{{ $item->id }}">
                                                    <!-- Info Tab: Edit basic exam details -->
                                                    ...
                                                    <div class="tab-pane container active" style="min-height: 300px; max-width: 1340px !important; margin: 15px 0;" id="info_edit{{ $item->id }}">
                                                        <div style="display: flex; flex-direction: column; align-items: flex-start; row-gap: 15px;">
                                                            <div class="col-md-12 d-flex align-items-center justify-content-around">
                                                                <span class="col-md-2" style="font-size: 1.2rem;">Title:</span>
                                                                <input type="text" name="title" value="{{ $item->title }}" class="col-md-9 form-control quizze_title">
                                                            </div>
                                                            <div class="col-md-12 d-flex align-items-center justify-content-around">
                                                                <span class="col-md-2" style="font-size: 1.2rem;">Description:</span>
                                                                <textarea class="col-md-9 form-control quizze_description" name="description" id="dec_quizze" cols="30" rows="3">{{ $item->description }}</textarea>
                                                            </div>
                                                            <div class="col-md-12 d-flex align-items-center justify-content-around">
                                                                <span class="col-md-2" style="font-size: 1.2rem;">Duration:</span>
                                                                <div class="col-md-9" style="display: flex; align-items: center; padding: 0; justify-content: start">
                                                                    <input name="time" value="{{ $item->time }}" max="60" min="0" class="col-md-4 form-control quizze_duration">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 d-flex align-items-center justify-content-around">
                                                                <span class="col-md-2" style="font-size: 1.2rem;">Score Name:</span>
                                                                <select class="col-md-9 form-control" id="score_id_edit" name="score_id">
                                                                    <option value="{{ @$item->score_id }}">{{ @$item->dia_score->name }}</option>
                                                                    @foreach ($scores as $score)
                                                                        <option value="{{ $score->id }}">{{ $score->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-md-12 d-flex align-items-center justify-content-around">
                                                                <span class="col-md-2" style="font-size: 1.2rem;">Total Score:</span>
                                                                <input type="text" name="score" value="{{ $item->score }}" class="col-md-9 form-control quizze_Total_Score">
                                                            </div>
                                                            <div class="col-md-12 d-flex align-items-center justify-content-around">
                                                                <span class="col-md-2" style="font-size: 1.2rem;">Pass Score:</span>
                                                                <input type="text" name="pass_score" value="{{ $item->pass_score }}" class="col-md-9 form-control quizze_Pass_Score">
                                                            </div>
                                                            <div class="col-md-12 d-flex align-items-center justify-content-around">
                                                                <span class="col-md-2" style="font-size: 1.2rem;">Active:</span>
                                                                <div class="col-md-9 p-0">
                                                                    <label class="btn-container">
                                                                        <input name="state" class="quizze_Active" value="1" type="checkbox" {{ $item->state == 1 ? 'checked' : '' }}>
                                                                        <div class="checkmark"></div>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <!-- Questions Tab: Edit selected questions -->
                                                    <div class="tab-pane container fade question_edit_parQ" style="min-height: 300px; max-width: 1340px !important; margin: 10px 0;" id="question_edit{{ $item->id }}">
                                                        <div style="display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
                                                            <div class="d-flex all_filter" id="all_filter{{ $item->id }}" style="margin-bottom: 1rem; align-items: center; flex-wrap: wrap; justify-content: flex-start; gap: 10px">
                                                                <span style="font-size: 1.2rem; font-weight: 600;">Filter Diagnostic:</span>
                                                                <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                                                    <span style="font-size: 1.2rem; font-weight: 600;">Year:</span>
                                                                    <select id="sel_year_edit" name="year" class="form-control">
                                                                        <option value="">Select Year</option>
                                                                        @for ($i = date('Y'); $i >= 1990; $i--)
                                                                            <option value="{{ $i }}">{{ $i }}</option>
                                                                        @endfor
                                                                ...
                                                                <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                                                    <span style="font-size: 1.2rem; font-weight: 600;">Month:</span>
                                                                    <select id="sel_month_edit" name="month" class="form-control">
                                                                        <option value="">Select Month</option>
                                                                        <option value="1">January</option>
                                                                        <option value="2">February</option>
                                                                        <option value="3">March</option>
                                                                ...
                                                                <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                                                    <span style="font-size: 1.2rem; font-weight: 600;">Section:</span>
                                                                    <select id="sel_section_edit" name="section" class="form-control">
                                                                        <option value="">Select Section</option>
                                                                        <option value="1">1</option>
                                                                        <option value="2">2</option>
                                                                        <option value="3">3</option>
                                                                ...
                                                                <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                                                    <span style="font-size: 1.2rem; font-weight: 600;">Code:</span>
                                                                    <select id="sel_code_edit" name="names" class="form-control">
                                                                        <option value="">Select Code</option>
                                                                        @foreach ($codes as $code)
                                                                            <option value="{{ $code->id }}">{{ $code->exam_code }}</option>
                                                                        @endforeach
                                                                ...
                                                                <div class="col-md-2 d-flex p-0" style="align-items: center; column-gap:10px">
                                                                    <span class="col-md-8 pr-0" style="font-size: 1.2rem; font-weight: 600;">Question Num:</span>
                                                                    <input type="number" id="sel_question_edit" class="col-md-4 form-control" style="padding: .375rem 0 !important; padding-left: 5px !important;" placeholder="Select Question Num">
                                                                </div>
                                                                <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                                                    <span style="font-size: 1.2rem; font-weight: 600;">Chapter:</span>
                                                                    <select id="sel_chp_edit{{ $item->id }}" name="names" class="form-control sel_chp_edit">
                                                                        <option value="">Select Chapter</option>
                                                                        @foreach ($chapters as $chapter)
                                                                            @if ($item->course->id == $chapter->course_id)
                                                                ...
                                                                <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                                                    <span style="font-size: 1.2rem; font-weight: 600;">Lesson:</span>
                                                                    <select id="sel_less_edit" name="names" class="form-control">
                                                                        <option value="">Select Lesson</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-2 d-flex" style="align-items: center; column-gap:10px">
                                                                ...
                                                                <div class="col-md-3 d-flex" style="align-items: center; justify-content: space-between; column-gap:20px">
                                                                    <button type="button" class="filterBtn_edit" id="filterBtn_edit{{ $item->id }}" style="font-size: 1.4rem; font-weight: 500; border: none; background: #1b84ff; border-radius: 8px; padding: 5px 25px; letter-spacing: 1px; color: #fff;">Filter</button>
                                                                    <button type="button" class="d-none" id="addAllBtn{{ $item->id }}" style="font-size: 1.4rem; font-weight: 500; border: none; background: #1b84ff; border-radius: 8px; padding: 5px 25px; letter-spacing: 1px; color: #fff;">Add All</button>
                                                                </div>
                                                            </div>
                                                            <input class="category" type="hidden" value="{{ $categories }}" />
                                                            <input class="course" type="hidden" value="{{ $courses }}" />
                                                            <!-- Table to display available questions for editing -->
                                                            <div style="max-height: 300px; overflow: scroll; padding: 12px 0; border-bottom: 2px solid #8f8f8f">
                                                                <table class="table table-striped" id="tblData_Quizzes_Edite">
                                                                    <thead class="border-bottom">
                                                                        <tr>
                                                                            <th scope="col" style="font-weight: 500; font-size: 1.1rem">#</th>
                                                                            <th scope="col" style="font-weight: 500; font-size: 1.1rem">Type</th>
                                                                    ...
                                                                    <tbody class="quizze_item lesson_quizze"></tbody>
                                                                </table>
                                                            </div>
                                                            <div class="d-flex" style="align-items: center; justify-content: center">
                                                                <span style="font-size: 2rem; font-weight: 500; background: #1b84ff; color: #fff; border-radius: 10px; padding: 10px 15px; margin-top: 10px;">Diagnostic Exam</span>
                                                            </div>
                                                            <!-- Table to display selected questions for editing -->
                                                            <div style="max-height: 300px; overflow: scroll; padding: 12px 0; border-bottom: 2px solid #8f8f8f">
                                                                <table class="table table-striped" id="tblData_Edite">
                                                                    <thead class="border-bottom">
                                                                        <tr>
                                                                    ...
                                                                    <tbody class="sel_quz_edit" id="sel_quz_edit{{ $item->id }}">
                                                                        @foreach ($item->question->sortBy('q_num') as $question)
                                                                            <tr class="tr_edite{{ $item->id }}" id="tr_edite{{ $question->id }}">
                                                                                ...
                                                                                <input type="hidden" value="{{ $item->id }}" class="diagnostic_edite_id" id="diagnostic_edite_id{{ $question->id }}" />
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary add_btn btn_Edit_quizze" id="btn_Edit_quizze{{ $item->id }}">Edit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            <!-- Modal for deleting a diagnostic exam -->
                            <div class="modal fade" id="modalDelete{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="modalCenterTitle">Delete Quiz</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="p-3">
                                            Are you sure you want to delete <span class="text-danger">{{ $item->title }}?</span>
                                        </div>
                                        <div class="modal-footer">
    ...
    <!-- JavaScript for handling modal navigation and empty table rows -->
    <script>
        $(document).ready(function() {
            ...
            // Close edit modal
            $(".cls_edite, .close_btn").click(() => {
                $(".modal_edit").modal("hide");
            });

            // Add empty row message if tables are empty
            const emptyRow = "<tr><td colspan='12' class='avil'>No Quizzes Available</td></tr>";
            function addEmptyRow() {
                if ($("#tblData tbody").html() === "") {
                    $("#tblData tbody").append(emptyRow);
                }
    ...
    <!-- JavaScript for handling course, chapter, and lesson selection, and question addition -->
    <script>
        $(document).ready(function() {
            // Hide menu action by default
            $("#menu_action").css("display", "none");

            // Populate chapters and lessons based on course selection
            $("#sel_course").change(function() {
                $("#sel_chp").empty().append('<option value="">Select Chapter</option>');
                $("#sel_less").empty().append('<option value="">Select Lesson</option>');
                $.ajax({
                    url: "{{ route('lessons') }}",
                    type: "GET",
                    ...
                    success: function(data) {
                        $(data.chapters).each((val, ele) => {
                            $("#sel_chp").append(`<option value="${ele.id}">${ele.chapter_name}</option>`);
                        });
                    }
                });
            });

            // Populate lessons based on chapter selection
            $("#sel_chp").change(function() {
                $("#sel_less").empty().append('<option value="">Select Lesson</option>');
                $.ajax({
                    url: "{{ route('lessons') }}",
                    type: "GET",
                    data: { chapter_id: $(this).val() },
                    success: function(data) {
                        $(data.lessons).each((val, ele) => {
                            $("#sel_less").append(`<option value="${ele.id}">${ele.lesson_name}</option>`);
                        });
                    }
                });
            });

            // Populate courses based on category selection
            let sel_category = document.querySelector('#sel_category');
            let sel_course = document.querySelector('#sel_course');
            let course = JSON.parse(document.querySelector('.course').value);
            sel_category.addEventListener('change', () => {
                sel_course.innerHTML = '<option selected disabled>Select Course ...</option>';
                course.forEach(element => {
                    if (sel_category.value == element.category_id) {
                        sel_course.innerHTML += `<option value="${element.id}">${element.course_name}</option>`;
                    }
                });
            });

            // Handle question selection and addition
            let quizze_item = document.querySelector('.quizze_item');
            let questions_data = document.querySelector('.questions_data');
            let quizzes = [];
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        data.forEach((element, index) => {
                            ...
                            quizze_item.innerHTML += `
                                <tr>
                                    ...
                                    <td class="code">${examCode}</td>
                                    <td class="section">${element.section}</td>
                                    <td class="noNum">${element.q_num}</td>
                                    <td class="diff">${element.difficulty}</td>
                                    <td class="chapter">${element.chapter_name}</td>
                                    <td class="lessone">${element.lesson_name}</td>
                                    <td class="p-0">
                                        <button type="button" class="add_qz">Add</button>
                                    </td>
                                </tr>`;
                        ...
                        $(document).on('click', ".add_qz", function() {
                            ...
                            const quziId = $row.find(".idd").text();
                            const quziType = $row.find(".type").text();
                            const quziYear = $row.find(".year").text();
                            const quziMonth = $row.find(".month").text();
                            const quziCode = $row.find(".code").text();
                            const quziNoNum = $row.find(".noNum").text();
                            const quziSection = $row.find(".section").text();
                            const quziChapter = $row.find(".chapter").text();
                            const quziLessone = $row.find(".lessone").text();
                            const quziDiff = $row.find(".diff").text();

                            $(this).addClass("selected_qz").removeClass("add_qz").text("Selected");
                        ...
                        $(document).on('click', '.remove_qz', function() {
                            const getIndex = $(this).closest("tr").index();
                            quizzes.splice(getIndex, 1);
                            $(this).closest("tr").remove();
                            questions_data.value = JSON.stringify(quizzes);
                            if ($("#tblData .sel_quz").html() === "") {
                        ...
                        $("#filterBtn").click(function() {
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    if (data.faild) {
                                        $("#addAllBtn").addClass('d-none');
                                        quizze_item.innerHTML += `<td colspan="12" class="avil">${data.faild}</td>`;
                                    } else {
                                        $("#addAllBtn").removeClass('d-none');
                                        data.questions.forEach((element, index) => {
                                            const examCode = element.code && element.code.exam_code ? element.code.exam_code : 'null';
                                            quizze_item.innerHTML += `
                                                <tr class="filterResult">
                                                    <th scope="row" class="idd d-none">${element.id}</th>
                                                    <th>${index + 1}</th>
                                                    <td class="type">${element.q_type}</td>
                                                    <td class="year">${element.year}</td>
                                                    ...
                                                    <td class="noNum">${element.q_num}</td>
                                                    <td class="diff">${element.difficulty}</td>
                                                    <td class="chapter">${element.api_lesson.api_chapter.chapter_name}</td>
                                                    <td class="lessone">${element.api_lesson.lesson_name}</td>
                                                    <td class="p-0">
                                                        <button type="button" class="add_qz">Add</button>
                                                    </td>
                                                </tr>`;
                                    ...
                                    $("#addAllBtn").click(function() {
                                        $(".filterResult").each((index, ele) => {
                                            $(ele).find(".add_qz").click();
                                        });
                                    });
                                }
                            });
    ...
    <script>
        $(document).ready(function() {
            ...
            // Populate lessons based on chapter selection in edit modal
            $(".sel_chp_edit").change(function() {
                const parFilterEdit = `#${$(this).closest(".all_filter").attr("id")}`;
                const chapterSelect = `#${$(this).attr("id")}`;
                const lessonSelect = $(parFilterEdit).find("#sel_less_edit");
                $(lessonSelect).empty().append('<option value="">Select Lesson</option>');
                $.ajax({
                    url: "{{ route('lessons') }}",
                    type: "GET",
                    data: { chapter_id: $(chapterSelect).val() },
                    success: function(data) {
                        $(data.lessons).each((val, ele) => {
                            $(lessonSelect).append(`<option value="${ele.id}">${ele.lesson_name}</option>`);
                        });
                    }
                });
            });

            // Filter questions in edit modal
            $(document).on("click", ".filterBtn_edit", function() {
                const parFilterEdit = `#${$(this).closest(".all_filter").attr("id")}`;
                const filterBtnEdit = `#${$(parFilterEdit).find(".filterBtn_edit").attr("id")}`;
                const addAllBtnEdit = `#${$(filterBtnEdit).next().attr("id")}`;
                const lessonQuizze = $(parFilterEdit).parent().find(".lesson_quizze");
                $.ajax({
                    url: "{{ route('dia_filter_question') }}",
                    type: "GET",
                    data: {
                    ...
                    success: function(data) {
                        ...
                        if (data.faild) {
                            $(addAllBtnEdit).addClass('d-none');
                            lessonQuizze.append(`<td colspan="12" class="avil">${data.faild}</td>`);
                        } else {
                            $(addAllBtnEdit).removeClass('d-none');
                            data.questions.forEach((element, index) => {
                                const examCode = element.code && element.code.exam_code ? element.code.exam_code : 'null';
                                lessonQuizze.append(`
                                    <tr class="filterResultEdit">
                                        <input type="hidden" value="${element.id}" class="question_id ques_id quizze_ID" />
                                        <th>${index + 1}</th>
                                        <td class="type">${element.q_type}</td>
                                        <td class="year">${element.year}</td>
                                        ...
                                        <td class="noNum">${element.q_num}</td>
                                        <td class="diff">${element.difficulty}</td>
                                        <td class="chapE">${element.api_lesson.api_chapter.chapter_name}</td>
                                        <td class="lessE">${element.api_lesson.lesson_name}</td>
                                        <td class="p-0">
                                            <button type="button" class="edit_qz add_question">Add</button>
                                        </td>
                                    </tr>`);
                            ...
                            $(addAllBtnEdit).click(function() {
                                $(".filterResultEdit").each((index, ele) => {
                                    $(ele).find(".edit_qz").click();
                                });
                            });
                        }
                    }
            ...
            $(document).on("click", ".edit_qz", function() {
                const $row = $(this).closest("tr");
                const question_idd = $row.find(".ques_id").val();
                const quizze_idd = $(this).closest(".form_editquizze").find("#dia_id").val();
                const quziType = $row.find(".type").text();
                const quziYear = $row.find(".year").text();
                const quziMonth = $row.find(".month").text();
                const quziCode = $row.find(".code").text();
                ...
                const quziSection = $row.find(".section").text();
                const quziDiff = $row.find(".diff").text();
                const quziChap = $row.find(".chapE").text();
                const quziLess = $row.find(".lessE").text();
                const edit_eray = `#${$(this).closest(".form_editquizze").find(".sel_quz_edit").attr("id")}`;

                $(this).addClass("selected_qz").removeClass("edit_qz").text("Selected");

                const new_Ele_Edit = `
                    <tr class="tr_edite${quizze_idd}" id="tr_edite${question_idd}">
                        <input type="hidden" value="${question_idd}" name="question_id[]" class="question_edite_id" id="question_edite_id${question_idd}"/>
                        <input type="hidden" value="${quizze_idd}" class="diagnostic_edite_id" id="diagnostic_edite_id${question_idd}"/>
                        <td class="question_edite_type" id="question_edite_type${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziType}</td>
                        <td class="question_edite_year" id="question_edite_year${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziYear}</td>
                        <td class="question_edite_month" id="question_edite_month${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziMonth}</td>
                        <td class="question_edite_code" id="question_edite_code${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziCode}</td>
                        <td class="question_edite_section" id="question_edite_section${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziSection}</td>
                        <td class="question_edite_num" id="question_edite_num${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziNoNum}</td>
                        <td class="question_edite_difficulty" id="question_edite_difficulty${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziDiff}</td>
                        <td class="question_edite_chapter" id="question_edite_chapter${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziChap}</td>
                        <td class="question_edite_lesson" id="question_edite_lesson${question_idd}" style="font-weight: 500; font-size: 1.1rem">${quziLess}</td>
                        <td style="width: 150px !important; padding: 0 !important;">
                            <button type="button" class="remove_qz_edit">Remove</button>
                        </td>
                    </tr>`;
                $(edit_eray).append(new_Ele_Edit);
                quizzesEdit.push({ id: question_idd });
                $(edit_eray).closest('form').find('.add_new_questions').val(JSON.stringify(quizzesEdit));
            ...
            // Remove question in edit modal
            $(document).on('click', '.remove_qz_edit', function() {
                const edit_eray = `#${$(this).closest(".form_editquizze").find(".sel_quz_edit").attr("id")}`;
                const question_id = $(this).closest("tr").find(".question_edite_id").val();
                const getIndex = quizzesEdit.findIndex(q => q.id === question_id);
                if (getIndex !== -1) {
                    quizzesEdit.splice(getIndex, 1);
                }
                $(this).closest("tr").remove();
                $(edit_eray).closest('form').find('.add_new_questions').val(JSON.stringify(quizzesEdit));
                if ($(edit_eray).find("tr").length === 0) {
                    $(edit_eray).append("<tr><td colspan='12' class='avil'>No Quizzes Available</td></tr>");
                }
            });

            // Handle edit form submission
            $(document).on("click", ".btn_Edit_quizze", function() {
                const $form = $(this).closest(".form_editquizze");
                const parModel = `#${$form.find(".tab-content").attr("id")}`;
                const edit_eray = `#${$form.find(".sel_quz_edit").attr("id")}`;
                const info_obj = {
                    diagnostic_ID: $form.find("#dia_id").val(),
                    title: $form.find(".quizze_title").val(),
                    description: $form.find(".quizze_description").val(),
                    time: $form.find(".quizze_duration").val(),
                    scoreId: $form.find("#score_id_edit").val(),
                    score: $form.find(".quizze_Total_Score").val(),
                    pass_score: $form.find(".quizze_Pass_Score").val(),
                    state: $form.find(".quizze_Active").is(":checked") ? 1 : 0
                };
                const allDataEdite = [info_obj, ...quizzesEdit];

                $.ajax({
                    url: "{{ route('edit_dia_exam_item', ['id' => $item->id]) }}",
                    type: 'POST',
                    data: { data: JSON.stringify(allDataEdite) },
                    success: function(data) {
                        location.reload();
                    },
                    error: function(xhr) {
                        console.error('Error updating exam:', xhr.responseText);
                    }
                });
            });
        });
